 ...
 */
class MonthFragment : Fragment(), OnCheckedChangeListener {
        ...
        when(checkedId){
            R.id.filter_all ->{
                ...
                newFilterList.forEach{
                    if(it.catagory == "Expense")
                        expense +=it.amount
                    else if(it.catagory == "Saving")
                        saving += it.amount
                }
            ...
            R.id.filter_expense  ->{
                ...
                newFilterList=newFilterList.filter { it.catagory == "Expense" }
                newFilterList.forEach{ sum-=it.amount }
            }

            R.id.filter_saving ->{
                //  Toast.makeText(activity,"saving",Toast.LENGTH_LONG).show()
                newFilterList=newFilterList.filter { it.catagory == "Saving" }
                newFilterList.forEach{ sum+=it.amount }
            }
        }

        grand_total.text = sum.toString()
        spendList.clear()
